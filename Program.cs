...
class Program
{
    static void Main()
    {
        ...
        Question question4 = new Question() { questionText = "In which continent is Costa Rica situated?", optionA = "Asia", optionB = "North America", optionC = "South America", optionD = "Africa", correctAnswerLetter = 'B' };
